...
<p>La présente Politique de Confidentialité explique comment THE DISTRICT COMPANY collecte et utilise vos données personnelles. En utilisant les services de THE DISTRICT COMPANY, vous consentez à ce que THE DISTRICT COMPANY utilise vos données personnelles de la manière décrite dans la présente Politique de Confidentialité.
</p>

<p>Soyez assuré que THE DISTRICT COMPANY s’est engagé à collecter et utiliser vos données personnelles de manière responsable, sécurisée et en toute transparence. Si vous avez le moindre doute, ou une question, contactez-nous à best-K@district.fr.
</p>
<p>1. Informations que nous collectons sur vous, et les raisons de cette collecte</p>

<p>Si vous souhaitez obtenir de plus amples informations sur une section particulière, vous pouvez nous contacter.</p>

<p>Lorsque vous rejoignez THE DISTRICT COMPANY, nous collectons les informations d’enregistrement, afin que nous puissions :</p>
    <p>Créer votre compte, et que votre Restaurant apparaisse sur notre plateforme en ligne.
    ...
    Vous faire bénéficier au mieux du système de géolocalisation.</p>

    <p>Vous fournir des informations lorsque des transactions sont réalisés en ligne sur votre Restaurant :</p>

        <p>Traitement des commandes et facturation
    Demandes client
    ...
    Prévenir de toute fraude et autres actes qui pourraient enfreindre la loi, et vous protéger.</p>

    <p>Commentaires, axes d’amélioration, et autres informations essentielles</p>

    <p> Répondre à vos questions, vos demandes, vos besoins
    Etudier, analyser, développer et améliorer nos services
    Informations sur votre activité sur le site THE DISTRICT COMPANY.</p>
    ...
    <p> Les clients : ils passent commande, dans le cadre de nos services, auprès de votre Restaurant.
    ...
    Les organismes d’application de la loi : agence gouvernementale, organismes réglementaires, tribunaux ou autre tiers compétents, nous obligeant à divulguer des informations en vertu de la législation et des réglementations applicables.</p>

    <p>3. Traitement des données</p>
    ...
    <p>Chez THE DISTRICT COMPANY, nous accordons une grande importance à la sécurité et la protection de vos données personnelles, notamment contre tout accès non autorisé, tout traitement illégal, destruction, perte. Notre équipe technique met en oeuvre des mesures afin de garantir la sécurité de vos informations.</p>
    <p>5. Conservation des données</p>

    <p>Chez THE DISTRICT COMPANY, nous conservons l’ensemble de vos données le temps nécessaire pour satisfaire aux finalités décrites dans cette Politique de Confidentialité. Par exemple, toute la période durant laquelle votre Restaurant est référencé et présent sur notre plateforme. Dans le cadre de la tenue de nos dossiers, et le respect de nos obligations légales, nous pouvons être à-même de conserver certains éléments de vos données personnelles pour une période ultérieure à votre désactivation et suppression de compte.</p>
    <p>6. Droits relatifs à la protection de vos données</p>

<p>Vous êtes en droit de nous contacter afin de nous demander de supprimer vos données personnelles ou de limiter leur traitement. Pour se faire, vous pouvez nous contacter sur : best-K@district.fr</p>
<p>7. Liens vers d’autres sites</p>

<p>Chez THE DISTRICT COMPANY, nous sommes et serons amenés à réaliser des partenariats stratégiques, des liens d’affiliation avec des annonceurs et autres partenaires de différents secteurs. Nos sites web et espaces personnels peuvent donc contenir des liens vers des sites tiers. Si vous suivez ces liens, sachez que THE DISTRICT COMPANY n’est pas responsable de ces sites, qui ont leurs propres Politiques de confidentialité, et mènent leurs propres politiques commerciales.</p>
<p>8. Mise à jour de cette Politique de Confidentialité</p>
...
<p>9. Coordonnées pour nous contacter</p>

<p>Pour toute question, demande d’informations supplémentaires, ou préoccupation concernant notre Politique de Confidentialité ou nos services, vous pouvez nous contacter sur : best-K@district.fr.</p>
</div>
</section>
      <?php
       include('footer.php');
